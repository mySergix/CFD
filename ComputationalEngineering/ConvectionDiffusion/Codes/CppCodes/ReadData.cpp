...
#define DIRECTORIO "/home/sergiogus/Desktop/ComputationalEngineering/ConvectionDiffusion/InputData/"
...
ReadData::ReadData(Memory M1, int N){
	...
	NumericalData = M1.AllocateInt(5, 1, 1); //Datos numéricos del problema
	...
	FactorRelax = M1.AllocateDouble(N, 1, 1);
}
...
void ReadData::ReadInputs(){
	...
	ReadArrays("PhysicalData.txt", 7, ProblemPhysicalData);	  //Input Datos físicos de las condiciones del problema
