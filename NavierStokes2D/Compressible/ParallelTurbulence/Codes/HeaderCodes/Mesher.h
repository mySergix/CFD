...
class Mesher{
	...
	public:
		...
		void Get_DeltasChannel(); //Cálculo de las distancias entre nodos en cada una de las matrices para el caso del Canal
		void Get_Surfaces(); //Cálculo de las superficies de cada uno de los volúmenes de control
		void Get_SurfacesChannel(); //Cálculo de las superficies de cada uno de los volúmenes de control para el caso del canal
		void Get_Volumes(); //Cálculo de los volúmenes de control de cada volúmen
		void Get_VolumesChannel(); //Cálculo de los volúmenes de control de cada volúmen para el caso del canal
		void Get_Angles();
		...
		int ReturnNR(){ return NR; }

		void PrintTxt(); //Pasar los resultados de las mallas a un txt
		void MallaVTK2D(string, string, string, double*, int, int); //Pasar todos los resultados escalares en 2D a un archivo VTK
		

		void ExecuteMesher(Memory, Geometry, ParPro); //Ejecutar todos los procesos del mallador
};
