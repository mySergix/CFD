...
void Mesher::AllocateMemory(Memory M1){
	...
	SupMR = M1.AllocateDouble3D(NA, NRad, 4, "V"); //Superficies de los volúmenes de la matriz de velocidades radiales (V)
	...
	VolMR = M1.AllocateDouble2D(NA, NRad+1); //Volúmenes de los volúmenes de la matriz de velocidades radiales (V)
...
int i, j;
	...
	FILE *fp1;
	fp1 = fopen("/home/sergio/Desktop/TFG/RegimenTurbulento/MeshResults/GnuPlot/MallaPresion.txt","w");
	for(i = 0; i < NA; i++){
        	for(j = 0; j < NRad; j++){
			fprintf(fp1,"%f %f \n",MP[i][j][0],MP[i][j][1]);
		}
	...
	FILE *fp2;
	fp2 = fopen("/home/sergio/Desktop/TFG/RegimenTurbulento/MeshResults/GnuPlot/MallaV.txt","w");
	for(i = 0; i < NA; i++){
        	for(j = 0; j < 1; j++){
			fprintf(fp1,"%f %f \n",MR[i][j][0],MR[i][j][1]);
		}
	...
	FILE *fp3;
	fp3 = fopen("/home/sergio/Desktop/TFG/RegimenTurbulento/MeshResults/GnuPlot/MallaU.txt","w");
	for(i = 0; i < NA+1; i++){
        	for(j = 0; j < NRad; j++){
			fprintf(fp1,"%f %f \n",MU[i][j][0],MU[i][j][1]);
		}
	...
	FILE *fp4;
	fp4 = fopen("/home/sergio/Desktop/TFG/RegimenTurbulento/MeshResults/GnuPlot/AngulosMU.txt","w");
	for(j = NRad-1; j >= 0; j--){
        	for(i = 0; i < NA+1; i++){
			fprintf(fp4,"%f ",AngleMU[i][j]);
			}
        	fprintf(fp4, "\n");
    	}
	fclose(fp4);
	...
	FILE *fp5;
	fp5 = fopen("/home/sergio/Desktop/TFG/RegimenTurbulento/MeshResults/GnuPlot/AngulosMR.txt","w");
	for(j = NRad; j >= 0; j--){
        	for(i = 0; i < NA; i++){
			fprintf(fp5,"%f ",AngleMR[i][j]);
			}
        	fprintf(fp5, "\n");
    	}
	fclose(fp5);
	...
	FILE *fp6;
	fp6 = fopen("/home/sergio/Desktop/TFG/RegimenTurbulento/MeshResults/GnuPlot/DeltasMP_X.txt","w");
	for(j = NRad-1; j >= 0; j--){
        	for(i = 0; i < NA; i++){
			fprintf(fp6,"%f ",DeltasMP[i][j][0]);
			}
        	fprintf(fp6, "\n");
    	}
	fclose(fp6);
	...
	FILE *fp7;
	fp7 = fopen("/home/sergio/Desktop/TFG/RegimenTurbulento/MeshResults/GnuPlot/DeltasMU_X.txt","w");
	for(j = NRad-1; j >= 0; j--){
        	for(i = 0; i < NA+1; i++){
			fprintf(fp7,"%f ",DeltasMU[i][j][0]);
			}
        	fprintf(fp7, "\n");
    	}
	fclose(fp7);
	...
	FILE *fp8;
	fp8 = fopen("/home/sergio/Desktop/TFG/RegimenTurbulento/MeshResults/GnuPlot/DeltasMR_X.txt","w");
	for(j = NRad; j >= 0; j--){
        	for(i = 0; i < NA; i++){
			fprintf(fp8,"%f ",DeltasMR[i][j][0]);
			}
        	fprintf(fp8, "\n");
    	}
	fclose(fp8);
	...
	FILE *fp9;
	fp9 = fopen("/home/sergio/Desktop/TFG/RegimenTurbulento/MeshResults/GnuPlot/DeltasMP_Y.txt","w");
	for(j = NRad-1; j >= 0; j--){
        	for(i = 0; i < NA; i++){
			fprintf(fp9,"%f ",DeltasMP[i][j][1]);
			}
        	fprintf(fp9, "\n");
    	}
	fclose(fp9);
	...
	FILE *fp10;
	fp10 = fopen("/home/sergio/Desktop/TFG/RegimenTurbulento/MeshResults/GnuPlot/DeltasMU_Y.txt","w");
	for(j = NRad-1; j >= 0; j--){
        	for(i = 0; i < NA+1; i++){
			fprintf(fp10,"%f ",DeltasMU[i][j][1]);
			}
        	fprintf(fp10, "\n");
    	}
	fclose(fp10);
	...
	FILE *fp11;
	fp11 = fopen("/home/sergio/Desktop/TFG/RegimenTurbulento/MeshResults/GnuPlot/DeltasMR_Y.txt","w");
	for(j = NRad; j >= 0; j--){
        	for(i = 0; i < NA; i++){
			fprintf(fp11,"%f ",DeltasMR[i][j][1]);
			}
        	fprintf(fp11, "\n");
    	}
	fclose(fp11);
	...
	FILE *fp12;
	fp12 = fopen("/home/sergio/Desktop/TFG/RegimenTurbulento/MeshResults/GnuPlot/SupMP_W.txt","w");
	for(j = NRad-1; j >= 0; j--){
        	for(i = 0; i < NA; i++){
			fprintf(fp12,"%f ",SupMP[i][j][0]);
			}
        	fprintf(fp12, "\n");
    	}
	fclose(fp12);
	...
	FILE *fp13;
	fp13 = fopen("/home/sergio/Desktop/TFG/RegimenTurbulento/MeshResults/GnuPlot/SupMP_E.txt","w");
	for(j = NRad-1; j >= 0; j--){
        	for(i = 0; i < NA; i++){
			fprintf(fp13,"%f ",SupMP[i][j][1]);
			}
        	fprintf(fp13, "\n");
    	}
	fclose(fp13);
	...
	FILE *fp14;
	fp14 = fopen("/home/sergio/Desktop/TFG/RegimenTurbulento/MeshResults/GnuPlot/SupMP_S.txt","w");
	for(j = NRad-1; j >= 0; j--){
        	for(i = 0; i < NA; i++){
			fprintf(fp14,"%f ",SupMP[i][j][2]);
			}
        	fprintf(fp14, "\n");
    	}
	fclose(fp14);
	...
	FILE *fp15;
	fp15 = fopen("/home/sergio/Desktop/TFG/RegimenTurbulento/MeshResults/GnuPlot/SupMP_N.txt","w");
	for(j = NRad-1; j >= 0; j--){
        	for(i = 0; i < NA; i++){
			fprintf(fp15,"%f ",SupMP[i][j][3]);
			}
        	fprintf(fp15, "\n");
    	}
	fclose(fp15);
	...
	FILE *fp16;
	fp16 = fopen("/home/sergio/Desktop/TFG/RegimenTurbulento/MeshResults/GnuPlot/MinimaDistancia.txt","w");
	for(j = NRad-1; j >= 0; j--){
        	for(i = 0; i < NA; i++){
			fprintf(fp16,"%f ",minDist[i][j]);
			}
        	fprintf(fp16, "\n");
    	}
	fclose(fp16);
...
int i, j;
	...
	//Esquina arriba izquierda
	VolMP[0][NRad-1] = (MU[i+1][NRad-1][0] - MU[i][NRad-1][0])*(PI/3.0)*(pow(0.50*(MR[0][NRad][1] + MR[1][NRad][1]),2.0) + pow(Rinicio,2.0) + 0.50*(MR[0][NRad][1] + MR[1][NRad][1])*Rinicio - pow(0.50*(MU[1][NRad-1][1] + MU[1][NRad-2][1]),2.0) - pow(0.50*(MU[0][NRad-1][1] + MU[0][NRad-2][1]),2.0) - 0.50*(MU[1][NRad-1][1] + MU[1][NRad-2][1])*0.50*(MU[0][NRad-1][1] + MU[0][NRad-2][1]));

	//Esquina arriba derecha
	VolMP[NA-1][NRad-1] = (MU[i+1][NRad-1][0] - MU[i][NRad-1][0])*(PI/3.0)*(pow(Rfinal,2.0) + pow(0.50*(MR[NA-1][NRad][1] + MR[NA-2][NRad][1]),2.0) + Rfinal*0.50*(MR[NA-1][NRad][1] + MR[NA-2][NRad][1]) - pow(0.50*(MU[NA][NRad-1][1] + MU[NA][NRad-2][1]),2.0) - pow(0.50*(MU[NA-1][NRad-1][1] + MU[NA-1][NRad-2][1]),2.0) - 0.50*(MU[NA][NRad-1][1] + MU[NA][NRad-2][1])*0.50*(MU[NA][NRad-1][1] + MU[NA][NRad-2][1]));
...
int i, j;
	...
	name_t<<"/home/sergio/Desktop/TFG/RegimenTurbulento/MeshResults/Paraview2/"<<Problema<<"_"<<Documento<<".vtk";
...
double J, K;
	...
	name_t<<"/home/sergio/Desktop/TFG/RegimenTurbulento/MeshResults/Paraview2/"<<Documento<<".vtk";
