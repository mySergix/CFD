...
class Solver{
	...
	public:
		...
		double *DensidadMediaTemporal;
		double *TemperaturaMediaTemporal;
		double *PresionMediaTemporal;

		double *DensidadMediaTemporalDato;
		double *TemperaturaMediaTemporalDato;
		double *PresionMediaTemporalDato;

		double TiempoEstadistico = 0.0;
